    ...
    try {
        ...
        if (user && passwordCheck && user.role === "user") {
            const userLoginToken = jwt.sign({
                ...
                return successResponse(res, "User has been logged in successfully", userLoginToken);
        }
            ...
            return successResponse(res, "Admin has been logged in successfully", adminLoginToken);
        }
        else {
